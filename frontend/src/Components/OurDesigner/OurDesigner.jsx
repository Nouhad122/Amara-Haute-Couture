    ...
    <section className={classes.ourDesigner}>
      ...
      <div className={classes.content}>
        <div className={classes.imageContainer}>
          <img 
            src={designerImage} 
            alt="Mariam El Hallab - Fashion Designer" 
